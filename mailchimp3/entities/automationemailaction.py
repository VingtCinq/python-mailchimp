...
class AutomationEmailAction(BaseApi):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        super(AutomationEmailAction, self).__init__(*args, **kwargs)
    ...
    def pause(self, workflow_id, email_id):
        ...
        return self._mc_client._post(url=self._build_path(workflow_id, 'emails', email_id, 'actions/pause-all-emails'))
    ...
    def start(self, workflow_id, email_id):
        ...
        self.workflow_id = workflow_id
        self.email_id = email_id
        return self._mc_client._post(url=self._build_path(workflow_id, 'emails', email_id, 'actions/start-all-emails'))
