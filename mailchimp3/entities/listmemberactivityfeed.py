# coding=utf-8
"""
The List Member Activity Feed API endpoint

Documentation: https://mailchimp.com/developer/reference/lists/list-members/list-member-activity-feed/
"""
...
class ListMemberActivityFeed(BaseApi):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        super(ListMemberActivityFeed, self).__init__(*args, **kwargs)
        self.endpoint = 'lists'
        self.list_id = None
